...
class http_event_collector:
    ...
    def __init__(self,token,http_event_server,input_type='json',host="",http_event_port='8088',http_event_server_ssl=True):
        ...
        if http_event_collector_debug:
            cbpi.app.logger.info("Token: " + self.token)
            cbpi.app.logger.info("Server: " + self.server_uri)
            cbpi.app.logger.info("InputType: " + self.input_type)               
    ...
    def sendEvent(self,payload,eventtime=""):
        ...
        if http_event_collector_debug:
            cbpi.app.logger.info("Single Submit: ")
